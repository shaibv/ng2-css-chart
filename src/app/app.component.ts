...
export class AppComponent {
  ...
  public doughnutConfiguration:ChartConfiguration = {holeRadius:100,radius:150,backgroundColor:'#f1e3dd',activeColor:'#667292',showText:true,text:{color:'#667292',size:20}};
}
